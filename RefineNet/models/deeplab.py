...
class ResNet101(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, phase, invariant=None, k=3, scale=0.0):
        self.inplanes = 64
        self.phase = phase
...
def Deeplab(num_classes=21, init_weights=None, restore_from=None, phase='train', invariant=None, k=3, scale=0.0):
    model = ResNet101(Bottleneck, [3, 4, 23, 3], num_classes, phase, invariant, k, scale)
